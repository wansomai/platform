...
const Footer = () => {
    ...
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <li>
                    <a href="/#ai-assistant" className="hover:underline me-4 md:me-6" aria-label=" try evacare for business">AI Assistant</a>
                </li>
                <li>
                    <a href="/#document-vault" className="hover:underline me-4 md:me-6" aria-label=" try evacare for business">Document Vault</a>
                </li>
                {/* <li>
                    <a href="/legal-documents" className="hover:underline me-4 md:me-6" aria-label="try evacare for individuals">Legal Documents</a>
                </li> */}
                <li>
                    <a href="/#workflows" className="hover:underline  me-4 md:me-6" aria-label="contact our support team">Workflows</a>
                </li>
                <li>
          ...
          <a href="https://www.linkedin.com/company/wansom-ai" target="blank" aria-label="visit our linkedin page">
          ...
          <a href="https://x.com/wansom_ai" target="blank" aria-label="visit our twitter page">   <svg className="w-6 h-6" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
