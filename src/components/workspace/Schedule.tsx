            ...
            <CardContent>
              {isLoading ? (
                ...
                <div className="text-center py-6">
                  ...
                  <p className="text-sm text-gray-500 mb-4">No events for this date</p>
                  <Button 
                    variant="outline" 
                    size="sm"
                  ...
                  {selectedDateEvents.map((event) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <Badge 
                          className={`mt-1 ${getEventTypeColor(event.type)} ${getEventTypeTextColor(event.type)}`}
                        >
