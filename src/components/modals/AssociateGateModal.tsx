...
interface AssociateGateModalProps {
  open: boolean;
  onClose: () => void;
  onUpgrade: () => void;
}
...
export default function AssociateGateModal({
  open,
  onClose,
  onUpgrade,
}: AssociateGateModalProps) {
  const handleUpgrade = () => {
    onClose();
    onUpgrade();
  };
          ...
          <div className="flex items-start gap-2.5 mb-4">
            ...
            <div className="min-w-0">
              <DialogTitle className="text-sm sm:text-[15px] font-semibold text-gray-900 leading-snug">
                AI Associates aren't on the Free plan
              </DialogTitle>
              <p className="text-[11px] text-gray-500 mt-0.5 leading-normal">
                Try Explorer — 2 weeks of full access, no commitment.
              </p>
            </div>
          </div>

          {/* Plan cards — always 2 columns; cards are narrow enough to fit all phones ≥ 320 px */}
            ...
            <div className="rounded-xl border border-gray-100 bg-gray-50 px-2.5 py-3 min-w-0">
              ...
              <ul className="space-y-1.5">
                ...
                <li className="flex items-start gap-1.5 min-w-0">
                  ...
                  <span className="text-[11px] text-gray-400 line-through leading-normal">AI Associates</span>
                </li>
              </ul>
            </div>
