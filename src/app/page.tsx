    ...
    <>
      ...
      <section className="py-20 bg-white" id="security">
        <div className="container mx-auto px-4 max-w-8xl">
          <div className=" bg-[url(/wansom-meeting.png)] bg-blend-multiply bg-cover bg-center bg-[#355e66] rounded-lg p-8">
            ...
            <button className="font-medium uppercase flex gap-1 items-center mx-auto text-white bg-dark hover:bg-[#d47b0f] rounded-md py-3 px-6">Book A Demo <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
